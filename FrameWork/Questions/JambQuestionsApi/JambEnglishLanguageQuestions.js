...
export function JambQuestionListEnglishLanguage({ navigation }) {
    ...
    try {
      ...
      while (fetchedQuestions.length < 5) {
        const response = await fetch(
          `https://questions.aloc.com.ng/api/v2/q?subject=english&type=utme&page=${currentPage}`,
          {
            headers: {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Theme.colors.primary }}>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("EnglishLanguageExamInfoScreenJamb")}
      >
          ...
          <>
            <View style={styles.questionContainer}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Text>
                  Exam Type: {questions[currentQuestionIndex].examtype}
                </Text>
                <Text>
