...
export function JambQuestionListChemistry({navigation}) {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      while (fetchedQuestions.length < 5) {
        const response = await fetch(`https://questions.aloc.com.ng/api/v2/q?subject=chemistry&type=utme&page=${currentPage}`, {
          headers: {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Theme.colors.primary }}>
      <TouchableOpacity style={{paddingLeft: 20, flexDirection: "row", alignItems: "center"}} onPress={() => navigation.navigate("ChemistryExamInfoScreenJamb")}>
          ...
          <>
            <View style={styles.questionContainer}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Text>Exam Type: {questions[currentQuestionIndex].examtype}</Text>
