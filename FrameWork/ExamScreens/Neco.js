...
export function Neco() {
    ...
    const subjects = [
      { name: "Mathematics", screen: "MathematicsScreenNeco" },
      { name: "English Language", screen: "EnglishScreenNeco" },
      { name: "Physics", screen: "PhysicsScreenNeco" },
      { name: "Chemistry", screen: "ChemistryScreenNeco" },
      { name: "Biology", screen: "BiologyScreenNeco" }
    ];
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily: Theme.fonts.text900, fontSize: 17}}>N.E.C.O</Text>
