...
export function Waec() {
    ...
    const subjects = [
      { name: "Mathematics", screen: "MathematicsScreen" },
      { name: "English Language", screen: "EnglishScreen" },
      { name: "Physics", screen: "PhysicsScreen" },
      { name: "Chemistry", screen: "ChemistryScreen" },
      { name: "Biology", screen: "BiologyScreen" }
    ];
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily: Theme.fonts.text900, fontSize: 17}}>W.A.E.C</Text>
