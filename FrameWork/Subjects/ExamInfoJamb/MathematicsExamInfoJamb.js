...
export function MathematicsExamInfoScreenJamb({navigation}) {
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily: Theme.fonts.text900, marginLeft: 5}}>Mathematics(Jamb)</Text>
      </View>
      ...
      <Text style={{fontFamily: Theme.fonts.text800, fontSize: 15, color: "#808080"}}>Ready to take the exam?</Text>
        ...
        <TouchableOpacity style={{borderRadius: 8, padding: 13, backgroundColor: Theme.colors.primary, alignItems: "center", marginTop: 70}}  onPress={() => navigation.navigate("JambquestionlistMathematics")}>
