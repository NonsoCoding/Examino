...
export function MathematicsScreen({navigation}) {
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <View>
        ...
        <TouchableOpacity style={{padding: 13, alignItems: "center", borderRadius: 8, backgroundColor: Theme.colors.primary}} onPress={() => navigation.navigate("MathematicsExamInfoScreen")}>
