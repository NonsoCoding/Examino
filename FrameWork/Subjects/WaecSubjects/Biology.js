...
export function BiologyScreen({navigation}) {
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily: Theme.fonts.text900, marginLeft: 5}}>Biology(waec)</Text>
      </View>
      ...
      <View>
        ...
        <TouchableOpacity style={{padding: 13, alignItems: "center", borderRadius: 8, backgroundColor: Theme.colors.primary}} onPress={()=> navigation.navigate("BiologyExamInfoScreen")}>
