...
export function PhysicsScreenJamb({navigation}) {
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
        ...
        <View style={{flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
          <View style={{padding: 5, backgroundColor: "white", borderRadius: 30}}>
            ...
            <View style={{marginLeft: 30}}>
                <Text style={{fontFamily: Theme.fonts.text800, paddingBottom: 4, fontSize: 14}}>Physics</Text>
      ...
      <View>
        ...
        <TouchableOpacity style={{padding: 13, alignItems: "center", borderRadius: 8, backgroundColor: Theme.colors.primary}} onPress={()=> navigation.navigate("PhysicsExamInfoScreenJamb")}>
