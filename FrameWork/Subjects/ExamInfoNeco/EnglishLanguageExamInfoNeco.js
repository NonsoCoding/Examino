...
export function EnglishLanguageExamInfoScreenNeco({navigation}) {
...
<SafeAreaView style={{flex: 1}}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily: Theme.fonts.text900, marginLeft: 5}}>English Language(Neco)</Text>
      </View>
      ...
      <Text style={{fontFamily: Theme.fonts.text800, fontSize: 15, color: "#808080"}}>Ready to take the exam?</Text>
        ...
        <View style={{borderBottomWidth: 0.5, borderTopWidth: 0.5, borderColor: "#808080", padding: 20, alignItems: "center"}}>
          <Text style={{fontFamily: Theme.fonts.text900, fontSize: 25}}>English Language</Text>
        </View>
        ...
        <TouchableOpacity style={{borderRadius: 8, padding: 13, backgroundColor: Theme.colors.primary, alignItems: "center", marginTop: 70}} onPress={()=> navigation.navigate("NecoquestionlistEnglishLanguage")}>
